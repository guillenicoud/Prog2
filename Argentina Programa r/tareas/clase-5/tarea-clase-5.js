...
console.log('Tarea 5 - Salario');

function calcularSalario () {
  let anual = document.getElementById("salario-anual").value;
  document.getElementById("salario-mensual").value = anual / 12;
}

let btncalular = document.getElementById("btn-calcular");
btncalular.addEventListener('click', calcularSalario);
...
function mostarResultado() {
  ...
  titulo.innerText  = 'Bienvenido '+ pNombre;;
}
